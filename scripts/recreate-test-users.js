...
async function recreateTestUsers() {
  ...
  const testUsers = [
    ...
    },
    {
      ...
      credentials: "MD",
      description:
        "Medical Doctor - Can perform all procedures including sharp debridement",
    },
    {
      ...
      credentials: "Admin",
      description:
        "Administrative user - Can view but limited procedure access",
    },
  ];
