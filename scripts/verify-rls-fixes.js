...
async function verify() {
  ...
  console.log('- user_invites: RLS = true, 4 policies (SELECT, 2x INSERT, UPDATE)');
  console.log('- wound_notes: RLS = true, 4 policies (SELECT, INSERT, UPDATE, DELETE)');
  console.log('- procedure_scopes: RLS = true, 2 policies (SELECT for all, ALL for tenant_admin)');
