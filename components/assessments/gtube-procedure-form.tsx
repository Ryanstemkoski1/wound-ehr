    ...
    try {
      ...
      toast.success(
        isDraft
          ...
          : "G-tube procedure submitted successfully"
      );
      if (onSuccess) {
        onSuccess();
      } else {
        ...
        <Tabs defaultValue="patient-info" className="w-full">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="comorbidAsthmaBronchitis"
                      {...register("comorbidAsthmaBronchitis")}
                    />
                    <Label htmlFor="comorbidAsthmaBronchitis">
                      Asthma/Bronchitis
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="comorbidObesity"
                      {...register("comorbidObesity")}
                    />
                    <Label htmlFor="comorbidObesity">Obesity</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="comorbidAlzheimers"
                      {...register("comorbidAlzheimers")}
                    />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setValue("procedurePerformed", checked as boolean)
                    }
                  />
                  <Label htmlFor="procedurePerformed">
                    Procedure Performed
                  </Label>
                </div>
                  ...
                  <>
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="initial-placement">
                            Initial Placement
                          </SelectItem>
                          <SelectItem value="replacement">
                            Replacement
                          </SelectItem>
                          <SelectItem value="assessment-only">
                            Assessment Only
                          </SelectItem>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(value) => setValue("tubeType", value)}
                  >
                    <SelectTrigger>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="peritubeSiteClean"
                      {...register("peritubeSiteClean")}
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="peritubeSiteDry"
                      {...register("peritubeSiteDry")}
                    />
                    <Label htmlFor="peritubeSiteDry">Dry</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="peritubeSiteIntact"
                      {...register("peritubeSiteIntact")}
                    />
                    <Label htmlFor="peritubeSiteIntact">Intact</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="peritubeGranulation"
                      {...register("peritubeGranulation")}
                    />
                    <Label htmlFor="peritubeGranulation">
                      Granulation Tissue
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="peritubeDrainage"
                      {...register("peritubeDrainage")}
                    />
                    <Label htmlFor="peritubeDrainage">Drainage</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="peritubeInduration"
                      {...register("peritubeInduration")}
                    />
                    <Label htmlFor="peritubeInduration">Induration</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="peritubeTenderness"
                      {...register("peritubeTenderness")}
                    />
                ...
                <div className="space-y-2">
                  <Label htmlFor="drainageDescription">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setValue("replacementPerformed", checked as boolean)
                    }
                  />
                  <Label htmlFor="replacementPerformed">
          ...
          <TabsContent value="verification" className="space-y-4">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="verificationAspiration"
                        {...register("verificationAspiration")}
                      />
                      <Label htmlFor="verificationAspiration">
                        Aspiration of Gastric Contents
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="verificationPhTest"
                        {...register("verificationPhTest")}
                      />
                      <Label htmlFor="verificationPhTest">pH Test</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="verificationAuscultation"
                        {...register("verificationAuscultation")}
                      />
                      <Label htmlFor="verificationAuscultation">
                        Auscultation
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="verificationXray"
                        {...register("verificationXray")}
                      />
                      <Label htmlFor="verificationXray">
                        X-ray Confirmation
                      </Label>
                    </div>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="patientInstructions">
                    Instructions Given
                  </Label>
                  <Textarea
