...
export function SkilledNursingAssessmentForm({
  ...
  const { register, handleSubmit, watch, setValue } =
    useForm<SkilledNursingAssessmentData>({
      defaultValues: {
        visitId,
        patientId,
        facilityId,
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h2 className="text-2xl font-bold">
              Skilled Nursing Visit Assessment
            </h2>
            <AutosaveIndicator
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setValue("hasPain", checked as boolean)
                    }
                  />
                ...
                {watchPain && (
                  <>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="painAggravatingFactors">
                        Aggravating Factors
                      </Label>
                      <Input
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setValue("cardiovascularWnl", checked as boolean)
                    }
                  />
                  <Label htmlFor="cardiovascularWnl">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="neckVeinDistention"
                      {...register("neckVeinDistention")}
                    />
                    <Label htmlFor="neckVeinDistention">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      defaultChecked
                    />
                    <Label htmlFor="capRefillUnder3sec">
                      Cap Refill &lt; 3 sec
                    </Label>
                  </div>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      onValueChange={(value) => setValue("edemaGrade", value)}
                    >
                      <SelectTrigger>
          ...
          <TabsContent value="resp" className="space-y-4">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="lungSoundsCta"
                        {...register("lungSoundsCta")}
                      />
                      <Label htmlFor="lungSoundsCta">
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="lungSoundsRales"
                        {...register("lungSoundsRales")}
                      />
                      <Label htmlFor="lungSoundsRales">Rales</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="lungSoundsRhonchi"
                        {...register("lungSoundsRhonchi")}
                      />
                      <Label htmlFor="lungSoundsRhonchi">Rhonchi</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="lungSoundsWheezes"
                        {...register("lungSoundsWheezes")}
                      />
                      <Label htmlFor="lungSoundsWheezes">Wheezes</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="lungSoundsCrackles"
                        {...register("lungSoundsCrackles")}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="lungSoundsAbsent"
                        {...register("lungSoundsAbsent")}
                      />
                      <Label htmlFor="lungSoundsAbsent">Absent</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="lungSoundsDiminished"
                        {...register("lungSoundsDiminished")}
                      />
                      <Label htmlFor="lungSoundsDiminished">Diminished</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="lungSoundsStridor"
                        {...register("lungSoundsStridor")}
                      />
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      {...register("hasCough")}
                      onCheckedChange={(checked) =>
                        setValue("hasCough", checked as boolean)
                      }
                    />
                ...
                {watchCough && (
                  <div className="space-y-2">
                    <Label htmlFor="sputumDescription">
                      Sputum Description
                    </Label>
                    <Input
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      {...register("onOxygen")}
                      onCheckedChange={(checked) =>
                        setValue("onOxygen", checked as boolean)
                      }
                    />
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setValue("onNebulizer", checked as boolean)
                      }
                    />
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="hearingImpairedLeft"
                        {...register("hearingImpairedLeft")}
                      />
                      <Label htmlFor="hearingImpairedLeft">Impaired Left</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="hearingImpairedRight"
                        {...register("hearingImpairedRight")}
                      />
                      <Label htmlFor="hearingImpairedRight">
                        Impaired Right
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="visionMacularDegeneration">
                ...
                <div className="space-y-2">
                  <Label htmlFor="decreasedSensation">
                    Decreased Sensation
                  </Label>
                  <Textarea
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(value) => setValue("catheterType", value)}
                  >
                    <SelectTrigger>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Select
                      onValueChange={(value) => setValue("bowelSounds", value)}
                    >
                      <SelectTrigger>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      {...register("decreasedAppetite")}
                    />
                    <Label htmlFor="decreasedAppetite">
                      Decreased Appetite
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="chewingSwallowingIssues">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setValue("tubeFeeding", checked as boolean)
                    }
                  />
                  ...
                  <>
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          onValueChange={(value) =>
                            setValue("tubeFeedingType", value)
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="tubeFeedingRateCcHr">
                          Rate (cc/hr)
                        </Label>
                        <Input
                          id="tubeFeedingRateCcHr"
                          type="number"
                          {...register("tubeFeedingRateCcHr", {
                            valueAsNumber: true,
                          })}
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Select
                          onValueChange={(value) =>
                            setValue("tubeFeedingMethod", value)
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="tubeFeedingPlacementChecked">
                        Placement Checked
                      </Label>
                    </div>
                  </>
          ...
          <TabsContent value="more" className="space-y-4">
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="medChangesSinceLastVisit">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="poorHomeEnvironment"
                      {...register("poorHomeEnvironment")}
                    />
                    <Label htmlFor="poorHomeEnvironment">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="impairedDecisionMaking">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      {...register("inappropriateBehavior")}
                    />
                    <Label htmlFor="inappropriateBehavior">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="musculoskeletalWnl"
                    {...register("musculoskeletalWnl")}
                  />
                  <Label htmlFor="musculoskeletalWnl">
                    Within Normal Limits
                  </Label>
                </div>
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="ambulationDifficulty"
                      {...register("ambulationDifficulty")}
                    />
                    <Label htmlFor="ambulationDifficulty">
