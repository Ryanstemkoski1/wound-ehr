  ...
  return (
    <RecordingProvider>
      <div className="flex">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-100 focus:rounded-md focus:bg-primary focus:px-4 focus:py-2 focus:text-white focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 focus:outline-none"
        >
        ...
        <div className="flex flex-1 flex-col">
          ...
          <main
            id="main-content"
            className="bg-background min-h-[calc(100vh-4rem)] px-4 py-6 pb-24 sm:px-6 sm:py-8 md:pb-8"
            role="main"
          >
            {children}
          </main>
