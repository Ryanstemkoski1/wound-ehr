...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      debridement_assessments: {
        Row: {
          additional_interventions: string[] | null
          anesthetic_used: string | null
          area_debrided: number | null
          assessment_date: string
          created_at: string | null
          created_by: string | null
          debridement_type: string | null
          depth_of_tissue_removed: string | null
          device_frequency: string | null
          device_mode: string | null
          dressing_change_days: number | null
          estimated_blood_loss: string | null
          facility_id: string | null
          goals_of_care: string[] | null
          has_tunneling: boolean | null
          has_undermining: boolean | null
          hemostasis_achieved: boolean | null
          hemostasis_method: string | null
          id: string
          include_medical_necessity: boolean | null
          instrument_used: string | null
          is_draft: boolean | null
          medical_necessity_custom: string | null
          method_used: string | null
          next_debridement_days: number | null
          pain_description: string | null
          pain_level: number | null
          patient_id: string
          periwound_skin: string[] | null
          periwound_skin_other: string | null
          place_of_service: string | null
          post_eschar_percent: number | null
          post_fibrotic_percent: number | null
          post_granulation_percent: number | null
          post_size_depth: number | null
          post_size_length: number | null
          post_size_width: number | null
          post_slough_percent: number | null
          pre_eschar_percent: number | null
          pre_fibrotic_percent: number | null
          pre_granulation_percent: number | null
          pre_size_depth: number | null
          pre_size_length: number | null
          pre_size_width: number | null
          pre_slough_percent: number | null
          procedure_notes: string | null
          referral_other: string | null
          referrals: string[] | null
          solution: string[] | null
          solution_other: string | null
          tissue_removed: string[] | null
          tunneling_clock_position: string | null
          tunneling_cm: number | null
          updated_at: string | null
          visible_structures: string[] | null
          visit_id: string
          wound_depth: string | null
          wound_duration_months: number | null
          wound_duration_weeks: number | null
          wound_duration_years: number | null
          wound_edges: string[] | null
          wound_location: string | null
          wound_type: string | null
          wound_type_other: string | null
        }
        Insert: {
          additional_interventions?: string[] | null
          anesthetic_used?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "debridement_assessments_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "debridement_assessments_facility_id_fkey"
            columns: ["facility_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "debridement_assessments_visit_id_fkey"
            columns: ["visit_id"]
            isOneToOne: false
            referencedRelation: "visits"
            referencedColumns: ["id"]
      ...
      incident_reports: {
        Row: {
          ...
          patient_facility_agency: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "incident_reports_signature_id_fkey"
      ...
      patient_not_seen_reports: {
        Row: {
          ...
          clinician_signature_id: string | null
          created_at: string | null
          created_by: string | null
          facility_id: string | null
          facility_notified: boolean | null
          family_notified: boolean | null
          follow_up_new_date: string | null
          follow_up_other: string | null
          follow_up_rescheduled: boolean | null
          id: string
          no_further_action: boolean | null
          patient_id: string
          pertinent_notes: string | null
          reason: string
          reason_other: string | null
          referral_source_notified: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "patient_not_seen_reports_clinician_signature_id_fkey"
            columns: ["clinician_signature_id"]
            isOneToOne: false
            referencedRelation: "signatures"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "patient_not_seen_reports_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "patient_not_seen_reports_facility_id_fkey"
            columns: ["facility_id"]
            isOneToOne: false
            referencedRelation: "facilities"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "patient_not_seen_reports_visit_id_fkey"
            columns: ["visit_id"]
            isOneToOne: false
            referencedRelation: "visits"
            referencedColumns: ["id"]
      ...
      treatments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "treatments_wound_id_fkey"
            columns: ["wound_id"]
            isOneToOne: false
            referencedRelation: "wounds"
            referencedColumns: ["id"]
