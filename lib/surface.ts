...
//
// This module is import-safe from both server and client code. The cookie-
// reading `getActiveSurface` lives in `lib/surface-server.ts` because it
// pulls in `next/headers`, which Next.js refuses to bundle into a client
// component.
