...
import SkinSweepAssessmentForm from "@/components/assessments/skin-sweep-assessment-form";
...
export default async function NewSkinSweepAssessmentPage({ params }: PageProps) {
    ...
    <div className="space-y-6">
      <DynamicBreadcrumbs
        customSegments={[
          ...
          { label: "New Skin Sweep Assessment" },
        ]}
      />
      ...
      <Card>
        <CardHeader>
          <CardTitle>Skin Sweep Assessment</CardTitle>
